...
var VirtualizedList = function () {
  ...
  VirtualizedList.prototype.render = function render() {
    ...
    // fixme maybe get the diff of the start element and the estimatedRowHeight??
    // this.content.style.transform = `translateY(${this.getRowOffset(start)}px)`;
    // this.content.style.top = this.getRowOffset(start) + 'px';

    let offsetY = this.getRowOffset(start)
