import { r as registerInstance, c as createEvent, h, H as Host, d as getElement } from './chunk-ee65d4c1.js';
...
var VirtualizedList = function () {
  function VirtualizedList(container, options) {
    ...
    _classCallCheck$1(this, VirtualizedList);
...
var InfiniteVirtualList = function (_VirtualList) {
  ...
  function InfiniteVirtualList() {
    _classCallCheck$2(this, InfiniteVirtualList);
...
class VList {
    constructor(hostRef) {
        ...
        this.mount = createEvent(this, "mount", 7);
        this.rowsRendered = createEvent(this, "rowsRendered", 7);
    }
    componentDidLoad() {
    ...
    static get watchers() { return {
        "generator": ["onChangedgenerator"],
        "renderRow": ["onChangedrenderRow"],
        "rowHeight": ["onChangedrowHeight"],
        "height": ["onChangedheight"],
        "rowCount": ["onChangedrowCount"],
        "initialScrollTop": ["onChangedinitialScrollTop"],
        "initialIndex": ["onChangedinitialIndex"],
        "overscanCount": ["onChangedoverscanCount"],
        "estimatedRowHeight": ["onChangedestimatedRowHeight"]
    }; }
    static get style() { return "v-list {\n  display: inline-block;\n  overflow-y: scroll;\n  overflow-x: hidden;\n  height: 100%;\n}"; }
}

export { VList as v_list };
